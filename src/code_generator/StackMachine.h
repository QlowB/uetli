...
public:
    ...
    ///
    virtual void execute(std::vector<void*>& stack, std::vector<void*>& variableStack) const = 0;
};
...
public:
    ...
    virtual void execute(std::vector<void*>& stack, std::vector<void*>& variableStack) const;
};
