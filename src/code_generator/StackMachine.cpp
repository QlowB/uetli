...
void LoadInstruction::execute(std::vector<void*>& stack, std::vector<void*>& variableStack) const
{
...
void StoreInstruction::execute(std::vector<void*>& stack, std::vector<void*>& variableStack) const
{
...
void DereferenceInstruction::execute(std::vector<void*>& stack, std::vector<void*>&) const
{
...
void DereferenceStoreInstruction::execute(std::vector<void*>& stack, std::vector<void*>&) const
{
...
void PopInstruction::execute(std::vector<void*>& stack, std::vector<void*>& variableStack) const
{
    stack.pop_back();
}
...
void CallInstruction::execute(std::vector<void*>& stack, std::vector<void*>& variableStack) const
{
...
void LoadConstantInstruction::execute(std::vector<void*>& stack, std::vector<void*>& variableStack) const
{
    stack.push_back((void*) constant);
}


void AllocateInstruction::execute(std::vector<void*>& stack, std::vector<void*>&) const
{
...
void DuplicateInstruction::execute(std::vector<void*>& stack, std::vector<void*>&) const
{
    stack.push_back(*(stack.end() - 1));
}


void PrintInstruction::execute(std::vector<void*>& stack, std::vector<void*>&) const
{
...
void Subroutine::execute(std::vector<void*>& stack, std::vector<void*>& variableStack) const
{
